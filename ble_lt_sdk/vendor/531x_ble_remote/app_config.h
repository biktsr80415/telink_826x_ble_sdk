...
/*---------------- Print Debug Tool                             --------------*/
/*----------------------------------------------------------------------------*/
#define PRINT_DEBUG_INFO              0       //Enable/Disable print debug tool
#if(PRINT_DEBUG_INFO)
	#define PRINT_BAUD_RATE           115200  //baud rate
	#define DEBUG_INFO_TX_PIN         GPIO_PA6//print pin
...
#else  //5316 hardware: C1T125A5_V1.0

	#define	GPIO_LED							GPIO_PB0

	#define		KB_MAP_NORMAL	{\
					{VK_WEB,		VK_UP,	    VK_ENTER,	VK_DOWN,	 CR_BACK}, \
					{VK_SLEEP,	 	VK_LEFT,	CR_HOME,	CR_VOL_MUTE, VK_RIGHT}, \
					{CR_POWER,	 	VK_NONE,	VK_7,   	VK_2,	     VK_BACKSPACE}, \
					{VK_NONE,	 	CR_VOL_DN,	VK_NONE,	VK_5,	     CR_VOL_UP}, \
					{VK_NONE,	 	VK_1,	    VK_0,	    VK_8,	     VK_3}, \
					{VK_NONE,		VK_4,	    VK_NONE,	VK_9,	     VK_6}, }
...
//////////////////Extern Crystal Type///////////////////////
#define CRYSTAL_TYPE			XTAL_24M		//  extern 12M crystal
