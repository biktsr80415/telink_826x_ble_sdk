...
const attribute_t my_Attributes[] = {
	...
	//    boot mouse input report   +7
	{0,ATT_PERMISSIONS_READ,2,1,(u8*)(&my_characterUUID), 		(u8*)(&bootMouseInReportProp), 0},
	{0,ATT_PERMISSIONS_READ,2, sizeof(bootMouseInReport), (u8*)(&hidbootMouseInReportUUID), 	(u8*)(&bootMouseInReport), 0},
	{0,ATT_PERMISSIONS_READ,2, sizeof(bootMouseInReportCCC), (u8*)(&clientCharacterCfgUUID), 	(u8*)(bootMouseInReportCCC), 0},
