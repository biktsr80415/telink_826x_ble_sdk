...
#if(__PROJECT_8266_AUDIO_MIC_SDM__ || __PROJECT_8267_AUDIO_MIC_SDM__ || __PROJECT_8269_AUDIO_MIC_SDM__ )
...
#if (TELINK_AUDIO_SERVICE_ENABLE)
	{55,0,0,0,0,0},	// total num of attribute
#else
...
#if (TELINK_AUDIO_SERVICE_ENABLE)
	// 002d  Audio Service
	{7,ATT_PERMISSIONS_READ,2,16,(u8*)(&my_primaryServiceUUID), 	(u8*)(&my_AudioUUID), 0},
	// 002e - 0030  MIC
