...
const u8	my_devName [] = {'t', 'M', 'o', 'd', 'u', 'l'};
...
const attribute_t my_Attributes[] = {
	...
	//8. boot keyboard input report (char-val-client)
	...
	//17. report in : 4 (char-val-client-ref)
