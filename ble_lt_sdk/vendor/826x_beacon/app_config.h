...
#if  (__PROJECT_8261_BEACON__)
	#define CHIP_TYPE				CHIP_TYPE_8261
	#define 						FLASH_TELINK_BEACON_CONFIG  0x0f000
	#define							GPIO_LED			GPIO_PC2
	#define 						PC2_OUTPUT_ENABLE	1

	#define							GPIO_BUTTON			GPIO_PB7
	#define 						PB7_INPUT_ENABLE	1
	#define 						PULL_WAKEUP_SRC_PB7 PM_PIN_PULLUP_1M  	//btn
#elif (__PROJECT_8266_BEACON__)
	#define CHIP_TYPE				CHIP_TYPE_8266
#elif (__PROJECT_8267_BEACON__)
