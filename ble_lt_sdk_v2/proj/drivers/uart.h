...
#define    UART_GPIO_CFG_PA0_PA2()  do{\
										REG_ADDR8(0x586) = REG_ADDR8(0x586)&(~(BIT(0)|BIT(2)));\
										REG_ADDR8(0x5a8) = REG_ADDR8(0x5a8)|(BIT(1)|BIT(4))&(~(BIT(0)|BIT(5)));\
										gpio_set_input_en(GPIO_PA0, 1);\
										gpio_set_input_en(GPIO_PA2, 0);\
										gpio_set_output_en(GPIO_PA0, 0);\
										gpio_set_output_en(GPIO_PA2, 1);\
                                    }while(0)

#define    UART_GPIO_CFG_PB0_PB1()  do{\
										REG_ADDR8(0x58e) = REG_ADDR8(0x58e)&(~(BIT(0)|BIT(1)));\
										REG_ADDR8(0x5aa) = REG_ADDR8(0x5aa)|(BIT(0)|BIT(2))&(~(BIT(1)|BIT(3)));\
...
#define    UART_GPIO_CFG_PB6_PB7()  do{\
										REG_ADDR8(0x58e) = REG_ADDR8(0x58e)&(~(BIT(6)|BIT(7)));\
										REG_ADDR8(0x5ab) = REG_ADDR8(0x5ab)|(BIT(5)|BIT(7))&(~(BIT(4)|BIT(6)));\
...
#define    UART_GPIO_CFG_PC4_PC5()  do{\
										REG_ADDR8(0x596) = REG_ADDR8(0x596)&(~(BIT(4)|BIT(5)));\
										REG_ADDR8(0x5ad) = REG_ADDR8(0x5ad)|(BIT(0)|BIT(2))&(~(BIT(1)|BIT(3)));\
...
#define    UART_GPIO_CFG_PD3_PD2()  do{\
										REG_ADDR8(0x59e) = REG_ADDR8(0x59e)&(~(BIT(2)|BIT(3)));\
										REG_ADDR8(0x5ae) = REG_ADDR8(0x5ae)|(BIT(5)|BIT(7))&(~(BIT(4)|BIT(6)));\
										gpio_set_input_en(GPIO_PD2, 1);\
										gpio_set_input_en(GPIO_PD3, 0);\
