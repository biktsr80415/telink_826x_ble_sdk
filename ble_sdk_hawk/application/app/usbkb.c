...
unsigned int debug_kbdata_report;
unsigned int debug_kbdata_report_normal;
unsigned int debug_kbdata_report_normal_ok;
unsigned int debug_kbdata_report_sys;
unsigned int debug_kbdata_report_sys_ok;
unsigned int debug_kbdata_report_media;
unsigned int debug_kbdata_report_media_ok;
