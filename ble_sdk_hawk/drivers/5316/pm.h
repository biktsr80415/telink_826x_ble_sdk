...
//int cpu_sleep_wakeup (int deepsleep, int wakeup_src, unsigned int wakeup_tick);
...
_attribute_no_inline_ unsigned int pm_get_32k_tick(void);
_attribute_no_inline_ void pm_set_32k_tick(unsigned int tick);
