...
cmd = array.new(4)
cmd[1] = HCI_TYPE_CMD
cmd[2] = HCI_CMD_LE_READ_LOCAL_SUPPORTED_FEATURES
...
print("\nhci_cmd_le_read_local_suppoered_features")
...
--  evtParamLen =  4 + x
--  resLen = 	   7 + x
local evtParamLen = 8    -- feature[0..7]
...
then
   print(string.format("0x%02x",resTbl[3]), "OK, evtParamLen = 8")  
else
...
--resTbl[5]: opCode_OCF 
if(resTbl[5] == HCI_CMD_LE_READ_LOCAL_SUPPORTED_FEATURES)  
then
