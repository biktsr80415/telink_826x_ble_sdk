...
---------------------------------------------------------------------------------
cmdheaderLen = 4;
cmdLen = 7;   --TODO parameter length

cmdTotalLen = cmdheaderLen + cmdLen;
cmd = array.new(cmdTotalLen)
cmd[1] = HCI_TYPE_CMD
cmd[2] = HCI_CMD_LE_READ_LOCAL_RESOLVABLE_ADDRESS
...
expectEvtParamLen = 7;  --TODO  Return parameter length
...
print("\n HCI_CMD_LE_READ_LOCAL_RESOLVABLE_ADDRESS ")
