...
---------------------------------------------------------------------------------
cmdheaderLen = 4;
cmdLen = 1;   --TODO parameter length

cmdTotalLen = cmdheaderLen + cmdLen;
cmd = array.new(cmdTotalLen)
cmd[1] = HCI_TYPE_CMD
cmd[2] = HCI_CMD_LE_SET_ADDRESS_RESOLUTION_ENABLE
...
expectEvtParamLen = 1;  --TODO  Return parameter length
...
print("\n HCI_CMD_LE_SET_ADDRESS_RESOLUTION_ENABLE ")
