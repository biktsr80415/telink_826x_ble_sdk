...
function hci_le_read_buf_size(status, ...)
arg = {...} 
...
opcode_OCF = HCI_CMD_LE_READ_BUF_SIZE
...
-- type_evt  evtCode(0e)  evtParamLen   numHciCmds   opCode_OCF   opCode_OGF         status   HC_LE_Data_Packet_Length   HC_Total_Num_LE_Data_Packets
--    1			1		  	   1		    1			1			 1			       1               2                             1
...
then
	...
	print(string.format("%02x  %02x  %02x  %02x  %02x  %02x  %02x  %02x  %02x  %02x", resTbl[1],resTbl[2],resTbl[3],resTbl[4],resTbl[5],resTbl[6],resTbl[7], resTbl[8],resTbl[9], resTbl[10]) )
