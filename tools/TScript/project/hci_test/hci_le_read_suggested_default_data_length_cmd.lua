...
function hci_le_read_suggested_default_data_length_cmd(status)


hci_type_cmd = HCI_TYPE_CMD
opcode_OCF = HCI_CMD_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH
...
print(string.format("\t\t\t\tHCI_CMD_LE_READ_SUGGESTED_DEFAULT_DATA_LENGTH") )
print("<-------------------------------------------------------------------------------------")
...
-- type_evt  evtCode(0e)  evtParamLen   numHciCmds   opCode_OCF   opCode_OGF         status   SuggestedMaxTxOctets  SuggestedMaxTxTime
--    1			1		  	   1		   1			1			 1			       1                2                    2
...
then
	...
	--print(string.format("%02x  %02x  %02x  %02x  %02x  %02x  %02x   %02x  %02x  %02x  %02x", resTbl[1],resTbl[2],resTbl[3],resTbl[4],resTbl[5],resTbl[6],resTbl[7],resTbl[8],resTbl[9],resTbl[10],resTbl[11]) )
	print(string.format("SuggestedMaxTxOctets: %04x \tSuggestedMaxTxTime: %04x ",resTbl[8]+resTbl[9]*256,resTbl[10]+resTbl[11]*256))
