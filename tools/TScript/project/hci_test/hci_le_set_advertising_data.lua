...
function bls_ll_setAdvData(status, advDataLen, ...)
arg = {...} 

hci_type_cmd = HCI_TYPE_CMD
opcode_OCF = HCI_CMD_LE_SET_ADVERTISE_DATA
opcode_OGF = HCI_CMD_LE_OPCODE_OGF
cmd_param_len = advDataLen + 1
...
-------for i=5,4+advDataLen,1 do print(cmd[i]) end  
end
...
print("<-------------------------------------------------------------------------------------")
print(string.format("\t\t\t\t\t(Data Length:0x%02x)", advDataLen) )
