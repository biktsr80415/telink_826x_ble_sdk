...
---------------------------------------------------------------------------------
cmdheaderLen = 4;
cmdLen = 0;   --TODO parameter length

cmdTotalLen = cmdheaderLen + cmdLen;
cmd = array.new(cmdTotalLen)
cmd[1] = HCI_TYPE_CMD
cmd[2] = HCI_CMD_LE_READ_RESOLVING_LIST_SIZE
...
expectEvtParamLen = 2;  --TODO  Return parameter length
...
print("\n HCI_CMD_LE_READ_RESOLVING_LIST_SIZE ")
